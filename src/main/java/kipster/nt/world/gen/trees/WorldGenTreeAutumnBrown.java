...
public class WorldGenTreeAutumnBrown extends WorldGenAbstractTree
{
    ...
    private static final IBlockState LEAF = BlockInit.AUTUMNLEAVESBROWN.getDefaultState();
    private final boolean useExtraRandomHeight;

    public WorldGenTreeAutumnBrown(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
