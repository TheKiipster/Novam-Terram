...
public class WorldGenTreeShrubRedOak extends WorldGenTrees
{
    private final IBlockState leavesMetadata;
    private final IBlockState woodMetadata;

    public WorldGenTreeShrubRedOak()
    {
        super(false);
        this.woodMetadata = Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK);
        this.leavesMetadata = BlockInit.OAKLEAVESRED.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false);
    }
