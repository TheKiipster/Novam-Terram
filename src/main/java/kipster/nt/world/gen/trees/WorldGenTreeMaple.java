...
public class WorldGenTreeMaple extends WorldGenAbstractTree 
{
    ...
    private static final IBlockState LEAF = BlockInit.MAPLELEAVES.getDefaultState();
    private final boolean useExtraRandomHeight;

    public WorldGenTreeMaple(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
