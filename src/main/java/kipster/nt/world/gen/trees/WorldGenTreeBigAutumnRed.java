...
public class WorldGenTreeBigAutumnRed extends WorldGenAbstractTree
{
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<WorldGenTreeBigAutumnRed.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new WorldGenTreeBigAutumnRed.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new WorldGenTreeBigAutumnRed.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeafNode(BlockPos pos)
    {
        ...
        {
            this.crosSection(pos.up(i), this.leafSize(i), BlockInit.AUTUMNLEAVESRED.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false)));
        }
    }
    ...
    void generateLeaves()
    {
        for (WorldGenTreeBigAutumnRed.FoliageCoordinates WorldGenTreeBigAutumnTaigaOrange$foliagecoordinates : this.foliageCoords)
        {
