...
public class WorldGenTreeBigOak extends WorldGenAbstractTree
{
    ...
    int heightLimit;
    int height;
    double heightAttenuation = 0.800D;
    ...
    List<WorldGenTreeBigOak.FoliageCoordinates> foliageCoords;
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<WorldGenTreeBigOak.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new WorldGenTreeBigOak.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new WorldGenTreeBigOak.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeaves()
    {
        for (WorldGenTreeBigOak.FoliageCoordinates WorldGenTreeBigRedOak$foliagecoordinates : this.foliageCoords)
        {
