...
public class WorldGenTreeShrubConiferOrange extends WorldGenTrees
{
    private final IBlockState leavesMetadata;
    private final IBlockState woodMetadata;

    public WorldGenTreeShrubConiferOrange()
    {
        super(false);
        this.woodMetadata = Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK);
        this.leavesMetadata = BlockInit.CONIFERLEAVESORANGE.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false);
    }
