...
public class WorldGenTreeAutumnOrange extends WorldGenAbstractTree
{
    ...
    private static final IBlockState LEAF = BlockInit.AUTUMNLEAVESORANGE.getDefaultState();
    private final boolean useExtraRandomHeight;

    public WorldGenTreeAutumnOrange(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
