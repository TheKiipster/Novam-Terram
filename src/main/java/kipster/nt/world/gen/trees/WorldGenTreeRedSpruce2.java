...
public class WorldGenTreeRedSpruce2 extends WorldGenAbstractTree
{
    ...
    public static final IBlockState LEAF = BlockInit.SPRUCELEAVESRED.getDefaultState();

    public WorldGenTreeRedSpruce2(boolean p_i2025_1_)
    {
        super(p_i2025_1_);
    }
