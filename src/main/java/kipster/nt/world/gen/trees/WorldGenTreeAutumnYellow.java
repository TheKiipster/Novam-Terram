...
public class WorldGenTreeAutumnYellow extends WorldGenAbstractTree
{
    ...
    private static final IBlockState LEAF = BlockInit.AUTUMNLEAVESYELLOW.getDefaultState();
    private final boolean useExtraRandomHeight;

    public WorldGenTreeAutumnYellow(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
