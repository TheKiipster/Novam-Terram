...
public class WorldGenTreeShrubRedSpruce extends WorldGenTrees
{
    private final IBlockState leavesMetadata;
    private final IBlockState woodMetadata;

    public WorldGenTreeShrubRedSpruce()
    {
        super(false);
        this.woodMetadata = Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.SPRUCE);
        this.leavesMetadata = BlockInit.SPRUCELEAVESRED.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false);
    }
