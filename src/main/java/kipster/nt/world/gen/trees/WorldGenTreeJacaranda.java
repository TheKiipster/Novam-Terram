...
public class WorldGenTreeJacaranda extends WorldGenAbstractTree 
{
    ...
    private static final IBlockState LEAF = BlockInit.JACARANDALEAVES.getDefaultState();
    private final boolean useExtraRandomHeight;

    public WorldGenTreeJacaranda(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
