...
public class WorldGenTreeBigAutumnTaigaYellow extends WorldGenAbstractTree
{
    private Random rand;
    private World world;
    ...
    List<WorldGenTreeBigAutumnTaigaYellow.FoliageCoordinates> foliageCoords;

    public WorldGenTreeBigAutumnTaigaYellow(boolean notify)
    {
        super(notify);
    }
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<WorldGenTreeBigAutumnTaigaYellow.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new WorldGenTreeBigAutumnTaigaYellow.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new WorldGenTreeBigAutumnTaigaYellow.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeafNode(BlockPos pos)
    {
        ...
        {
            this.crosSection(pos.up(i), this.leafSize(i), BlockInit.CONIFERLEAVESYELLOW.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false)));
        }
    }
    ...
    void generateLeaves()
    {
        for (WorldGenTreeBigAutumnTaigaYellow.FoliageCoordinates WorldGenTreeBigAutumnTaigaYellow$foliagecoordinates : this.foliageCoords)
        {
            this.generateLeafNode(WorldGenTreeBigAutumnTaigaYellow$foliagecoordinates);
        }
    }
    ...
    void generateLeafNodeBases()
    {
        for (WorldGenTreeBigAutumnTaigaYellow.FoliageCoordinates WorldGenTreeBigAutumnTaigaYellow$foliagecoordinates : this.foliageCoords)
        {
            int i = WorldGenTreeBigAutumnTaigaYellow$foliagecoordinates.getBranchBase();
            BlockPos blockpos = new BlockPos(this.basePos.getX(), i, this.basePos.getZ());

            if (!blockpos.equals(WorldGenTreeBigAutumnTaigaYellow$foliagecoordinates) && this.leafNodeNeedsBase(i - this.basePos.getY()))
            {
                this.limb(blockpos, WorldGenTreeBigAutumnTaigaYellow$foliagecoordinates, Blocks.LOG);
            }
        }
    }
