...
public class WorldGenTreeShrubCherryPink extends WorldGenTrees
{
    private final IBlockState leavesMetadata;
    private final IBlockState woodMetadata;

    public WorldGenTreeShrubCherryPink()
    {
        super(false);
        this.woodMetadata = Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.BIRCH);
        this.leavesMetadata = BlockInit.CHERRYLEAVESPINK.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false);
    }
