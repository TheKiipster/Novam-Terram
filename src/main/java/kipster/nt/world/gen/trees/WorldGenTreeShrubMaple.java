...
public class WorldGenTreeShrubMaple extends WorldGenTrees
{
    private final IBlockState leavesMetadata;
    private final IBlockState woodMetadata;

    public WorldGenTreeShrubMaple()
    {
        super(false);
        this.woodMetadata = Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK);
        this.leavesMetadata = BlockInit.MAPLELEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false);
    }
