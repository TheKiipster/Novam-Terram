...
public class WorldGenTreeShrubCherryWhite extends WorldGenTrees
{
    private final IBlockState leavesMetadata;
    private final IBlockState woodMetadata;

    public WorldGenTreeShrubCherryWhite()
    {
        super(false);
        this.woodMetadata = Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.BIRCH);
        this.leavesMetadata = BlockInit.CHERRYLEAVESWHITE.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false);
    }
