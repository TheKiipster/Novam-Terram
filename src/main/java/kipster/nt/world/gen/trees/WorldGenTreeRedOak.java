...
public class WorldGenTreeRedOak extends WorldGenAbstractTree 
{
    ...
    private static final IBlockState LEAF = BlockInit.OAKLEAVESRED.getDefaultState();
    private final boolean useExtraRandomHeight;

    public WorldGenTreeRedOak(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
