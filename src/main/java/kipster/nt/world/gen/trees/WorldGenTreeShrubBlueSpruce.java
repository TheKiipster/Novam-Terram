...
public class WorldGenTreeShrubBlueSpruce extends WorldGenTrees
{
    private final IBlockState leavesMetadata;
    private final IBlockState woodMetadata;

    public WorldGenTreeShrubBlueSpruce()
    {
        super(false);
        this.woodMetadata = Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.SPRUCE);
        this.leavesMetadata = BlockInit.SPRUCELEAVESBLUE.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false);
    }
