...
import net.minecraftforge.fml.common.registry.ForgeRegistries;
  ...
  public static void initBiomes(RegistryEvent.Register<Biome> event) {
	...
	registerBiome(bog, "bog", BiomeWeightConfig.bogWeight, MiscConfig.enableVillageInBog, BiomeType.WARM, Type.SWAMP);
	registerBiome(denseshrubland, "dense_shrubland", BiomeWeightConfig.denseshrublandWeight, MiscConfig.enableVillageInDenseShrubland, BiomeType.WARM, Type.PLAINS);
	...
	registerBiome(forestedextremehills, "forestedextremehills", BiomeWeightConfig.forestedextremehillsWeight, MiscConfig.enableVillageInForestedExtremeHills, BiomeType.WARM, Type.HILLS);
	registerBiome(forestedlakes, "forested_lakes", BiomeWeightConfig.forestedlakesWeight, MiscConfig.enableVillageInForestedLakes, BiomeType.WARM, Type.FOREST, Type.WATER);
	...
	registerBiome(monsoonforest, "monsoon_forest", BiomeWeightConfig.monsoonforestWeight, MiscConfig.enableVillageInMonsoonForest, BiomeType.WARM, Type.SWAMP, Type.BEACH, Type.JUNGLE, Type.WET);
	...
	registerBiome(shrubland, "shrubland", BiomeWeightConfig.shrublandWeight, MiscConfig.enableVillageInShrubland, BiomeType.WARM, Type.PLAINS);
	...
	registerBiome(goldensavanna, "golden_savanna", BiomeWeightConfig.goldensavannaWeight, MiscConfig.enableVillageInGoldenSavanna, BiomeType.DESERT, Type.SAVANNA);
	registerBiome(goldensavannaplateau, "golden_savanna_plateau", BiomeWeightConfig.goldensavannaplateauWeight, MiscConfig.enableVillageInGoldenSavannaPlateau, BiomeType.DESERT, Type.SAVANNA);
	...
	registerBiome(sandyscrubland, "sandy_scrubland", BiomeWeightConfig.sandyscrublandWeight, MiscConfig.enableVillageInSandyScrubland, BiomeType.DESERT, Type.SANDY);
