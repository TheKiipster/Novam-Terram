...
public class BiomeInit 
	{
		...
		public static Biome densemixedforesthills = new BiomeDenseMixedForest(new BiomeProperties("Dense Mixed Forest Hills").setBaseHeight(0.98F).setHeightVariation(0.37F).setTemperature(Biomes.FOREST.getDefaultTemperature()).setRainfall(Biomes.FOREST.getRainfall()));
		...
		public static Biome woodland = new BiomeWoodland(new BiomeProperties("Woodland").setBaseHeight(Biomes.FOREST.getBaseHeight()).setHeightVariation(Biomes.FOREST.getHeightVariation()).setTemperature(Biomes.FOREST.getDefaultTemperature()).setRainfall(Biomes.FOREST.getRainfall()));
		...
		public static void initBiomes()
		{
			...
			registerBiome(densemixedforest, "dense_mixed_forest", 5, Config.disableDenseMixedForest, false, BiomeType.WARM, Type.FOREST);
			registerBiome(densemixedforesthills, "dense_mixed_forest_hills", 2, Config.disableDenseMixedForestHills, false, BiomeType.WARM, Type.FOREST);
			...
			registerBiome(lake, "lake", 1, Config.disableLake, true, BiomeType.WARM, Type.WATER, Type.CONIFEROUS);
			registerBiome(woodland, "woodland", 6, Config.disableWoodland, false, BiomeType.WARM, Type.FOREST);
			...
			registerBiome(mapleforest, "maple_forest", 8, Config.disableMapleForest, false, BiomeType.COOL, Type.FOREST);
			...
			registerBiome(pineland, "pineland", 6, Config.disablePineland, false, BiomeType.COOL, Type.HILLS, Type.CONIFEROUS);
			registerBiome(pineforest, "pine_forest", 5, Config.disablePineForest, false, BiomeType.COOL, Type.CONIFEROUS);
			registerBiome(rockytaiga, "rocky_taiga", 8, Config.disableRockyTaiga, false, BiomeType.COOL, Type.FOREST);
			...
			registerBiome(lushdesert, "lush_desert", 4, Config.disableLushDesert, true, BiomeType.DESERT, Type.SAVANNA, Type.LUSH);
			...
			registerBiome(clayland, "clayland", 5, Config.disableClayland, false, BiomeType.DESERT, Type.SAVANNA);
			registerBiome(rockland, "rockland", 5, Config.disableRockland, false, BiomeType.DESERT, Type.SAVANNA);
