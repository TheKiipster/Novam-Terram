...
import kipster.nt.biomes.desert.BiomeGoldenSavanna.GoldGenerator;
...
public class BiomeGoldenSavanna extends Biome 
{
	...
	public BiomeGoldenSavanna(BiomeProperties properties)
	{	
		super(properties);
