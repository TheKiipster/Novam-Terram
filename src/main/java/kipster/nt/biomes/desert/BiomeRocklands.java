...
import kipster.nt.biomes.desert.BiomeRocklands.GoldGenerator;
...
public class BiomeRocklands extends Biome 
{
	...
	public BiomeRocklands() 
	{
		super(new BiomeProperties("Rocklands").setBaseHeight(0.82F).setHeightVariation(0.48F).setTemperature(0.8F).setRainfall(0.4F));
