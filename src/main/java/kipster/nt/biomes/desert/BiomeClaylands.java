...
import kipster.nt.biomes.desert.BiomeClaylands.GoldGenerator;
...
public class BiomeClaylands extends Biome 
{
	...
	public BiomeClaylands() 
	{
		super(new BiomeProperties("Claylands").setBaseHeight(0.82F).setHeightVariation(0.48F).setTemperature(0.8F).setRainfall(0.4F));
