...
import kipster.nt.biomes.desert.BiomeHotDesert.GoldGenerator;
...
public class BiomeHotDesert extends Biome 
{
	protected static final WorldGenLakes LAVA_LAKE_FEATURE = new WorldGenLakes(Blocks.LAVA);
	public BiomeHotDesert(BiomeProperties properties)
	{	
		super(properties);
	
		topBlock = BlockInit.HOTSAND.getDefaultState();
		fillerBlock = BlockInit.HOTSAND.getDefaultState();
