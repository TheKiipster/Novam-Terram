...
import kipster.nt.biomes.icy.BiomeColdBlueTaigaHills.DiamondGenerator;
...
public class BiomeColdBlueTaigaHills extends Biome 
{	
   ...
   public BiomeColdBlueTaigaHills(BiomeProperties properties)
  	{	
  		super(properties);
