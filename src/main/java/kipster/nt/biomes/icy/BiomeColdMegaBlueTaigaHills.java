...
import kipster.nt.biomes.icy.BiomeColdMegaBlueTaigaHills.DiamondGenerator;
...
public class BiomeColdMegaBlueTaigaHills extends Biome 
{	
	...
	private final WorldGenTreeMegaBlueSpruce spruceGenerator= new WorldGenTreeMegaBlueSpruce(false, true);
	   ...
	   public BiomeColdMegaBlueTaigaHills(BiomeProperties properties)
		{	
			super(properties);
