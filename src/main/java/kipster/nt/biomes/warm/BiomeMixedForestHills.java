...
import kipster.nt.biomes.warm.BiomeMixedForestHills.EmeraldGenerator;
...
public class BiomeMixedForestHills extends Biome 
{
	...
	public BiomeMixedForestHills(BiomeProperties properties)
	{	
		super(properties);
