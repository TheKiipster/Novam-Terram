...
import kipster.nt.biomes.warm.BiomePinelands.EmeraldGenerator;
...
public class BiomePinelands extends Biome 
{
	...
	{
		super(new BiomeProperties("Pinelands").setBaseHeight(0.91F).setHeightVariation(0.5F).setTemperature(0.4F).setRainfall(0.2F));
