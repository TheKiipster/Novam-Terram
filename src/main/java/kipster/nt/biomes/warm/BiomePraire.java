...
import kipster.nt.biomes.warm.BiomePraire.EmeraldGenerator;
...
public class BiomePraire extends Biome 
{
	...
	public BiomePraire(BiomeProperties properties)
	{	
		super(properties);
	...
	public void decorate(World worldIn, Random rand, BlockPos pos)
	{
	 ...
	 public int getModdedBiomeGrassColor(int original) {
		    return super.getModdedBiomeGrassColor(0xCAD24D);
		}
	 
	 @Override
	 public int getModdedBiomeFoliageColor(int original) {
		    return super.getModdedBiomeFoliageColor(0xADD24D);
