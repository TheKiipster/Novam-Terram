...
import kipster.nt.biomes.warm.BiomeDenseMixedForestHills.EmeraldGenerator;
...
public class BiomeDenseMixedForestHills extends Biome 
{
	...
	public BiomeDenseMixedForestHills(BiomeProperties properties)
	{	
		super(properties);
