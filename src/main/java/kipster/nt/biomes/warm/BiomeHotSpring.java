...
import kipster.nt.biomes.warm.BiomeHotSpring.EmeraldGenerator;
...
public class BiomeHotSpring extends Biome 
{
	...
	public BiomeHotSpring(BiomeProperties properties)
	{	
		super(properties);
	...
	public void decorate(World worldIn, Random rand, BlockPos pos)
	{
	 ...
	 public int getModdedBiomeGrassColor(int original) {
		    return super.getModdedBiomeGrassColor(0x7F9644);
		}
	 
	 @Override
	 public int getModdedBiomeFoliageColor(int original) {
		    return super.getModdedBiomeFoliageColor(0x7F9644);
