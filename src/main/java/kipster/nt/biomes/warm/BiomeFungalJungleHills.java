...
import kipster.nt.biomes.warm.BiomeFungalJungleHills.EmeraldGenerator;
...
public class BiomeFungalJungleHills extends Biome 
	{
    ...
    public BiomeFungalJungleHills(BiomeProperties properties)
   	{	
   		super(properties);
