...
import kipster.nt.biomes.cool.BiomeMegaBlueTaigaHills.DiamondGenerator;
...
public class BiomeMegaBlueTaigaHills extends Biome 
{	
	...
	private final WorldGenTreeMegaBlueSpruce spruceGenerator= new WorldGenTreeMegaBlueSpruce(false, true);
	   ...
	   public BiomeMegaBlueTaigaHills(BiomeProperties properties)
		{	
			super(properties);
