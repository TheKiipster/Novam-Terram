...
import kipster.nt.biomes.cool.BiomeMapleForestHills.DiamondGenerator;
...
public class BiomeMapleForestHills extends Biome 
{	
   ...
   public BiomeMapleForestHills(BiomeProperties properties)
  	{	
  		super(properties);
