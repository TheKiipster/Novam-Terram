...
import kipster.nt.biomes.cool.BiomeMegaAutumnTaigaHills.DiamondGenerator;
...
public class BiomeMegaAutumnTaigaHills extends Biome 
{	
	...
	private final WorldGenMegaPineTree spruceGenerator= new WorldGenMegaPineTree(false, true);
	   ...
	   public BiomeMegaAutumnTaigaHills(BiomeProperties properties)
		{	
			super(properties);
