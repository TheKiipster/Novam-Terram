...
import kipster.nt.biomes.cool.BiomeBlueTaigaHills.DiamondGenerator;
...
public class BiomeBlueTaigaHills extends Biome 
{	
   ...
   public BiomeBlueTaigaHills(BiomeProperties properties)
  	{	
  		super(properties);
