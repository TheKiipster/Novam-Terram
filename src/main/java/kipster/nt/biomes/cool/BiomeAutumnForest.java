...
import kipster.nt.biomes.cool.BiomeAutumnForest.DiamondGenerator;
...
{	
	...
	protected static final WorldGenTreeAutumnBrown BROWN_TREE = new WorldGenTreeAutumnBrown(false, false);
   ...
   @Override
	...
	if (rand.nextInt(3) > 0)
	{
		  return (WorldGenAbstractTree)(rand.nextInt(4) == 0 ? ORANGE_TREE : BROWN_TREE);
	}
