...
public class BlockLeavesWhiteMyrtle extends BlockLeaves implements IHasModel
{
	public BlockLeavesWhiteMyrtle(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.WHITEMYRTLESAPLING);
    }
