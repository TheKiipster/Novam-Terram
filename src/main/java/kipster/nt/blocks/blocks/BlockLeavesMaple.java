...
public class BlockLeavesMaple extends BlockLeaves implements IHasModel
{
	public BlockLeavesMaple(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.MAPLESAPLING);
    }
