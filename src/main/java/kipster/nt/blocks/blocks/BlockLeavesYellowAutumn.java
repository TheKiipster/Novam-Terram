...
public class BlockLeavesYellowAutumn extends BlockLeaves implements IHasModel
{
	public BlockLeavesYellowAutumn(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.AUTUMNSAPLINGYELLOW);
    }
