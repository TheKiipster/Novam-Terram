...
public class BlockLeavesConiferYellow extends BlockLeaves implements IHasModel
{
	public BlockLeavesConiferYellow(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.CONIFERSAPLINGYELLOW);
    }
