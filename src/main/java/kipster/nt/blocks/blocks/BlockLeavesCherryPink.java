...
public class BlockLeavesCherryPink extends BlockLeaves implements IHasModel
{
	public BlockLeavesCherryPink(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.CHERRYSAPLINGPINK);
    }
