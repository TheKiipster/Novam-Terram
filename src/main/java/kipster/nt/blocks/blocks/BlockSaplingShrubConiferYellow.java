...
public class BlockSaplingShrubConiferYellow extends BlockBush implements IHasModel, IGrowable
{
  ...
  public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
  {
      ...
      WorldGenerator worldgenerator = new WorldGenTreeShrubConiferYellow();
