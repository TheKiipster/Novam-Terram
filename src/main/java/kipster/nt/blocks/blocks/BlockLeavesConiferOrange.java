...
public class BlockLeavesConiferOrange extends BlockLeaves implements IHasModel
{
	public BlockLeavesConiferOrange(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.CONIFERSAPLINGORANGE);
    }
