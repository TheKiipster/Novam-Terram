...
public class BlockLeavesRedAutumn extends BlockLeaves implements IHasModel
{
	public BlockLeavesRedAutumn(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.AUTUMNSAPLINGRED);
    }
