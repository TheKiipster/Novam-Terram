...
public class BlockLeavesOrangeAutumn extends BlockLeaves implements IHasModel
{
	public BlockLeavesOrangeAutumn(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.AUTUMNSAPLINGORANGE);
    }
