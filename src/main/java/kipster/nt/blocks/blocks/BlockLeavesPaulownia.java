...
public class BlockLeavesPaulownia extends BlockLeaves implements IHasModel
{
	public BlockLeavesPaulownia(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.PAULOWNIASAPLING);
    }
