...
public class BlockLeavesOrchard extends BlockLeaves implements IHasModel
{
	public BlockLeavesOrchard(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.ORCHARDSAPLING);
    }
