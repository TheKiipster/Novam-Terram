...
public class BlockLeavesBrownAutumn extends BlockLeaves implements IHasModel
{
	public BlockLeavesBrownAutumn(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.AUTUMNSAPLINGBROWN);
    }
